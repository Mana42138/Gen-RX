        ...
        if cookie_found:
            ...
            if result is not None:
                ...
                if AUTO_LAUNCH:
                    ...
                    status("Adding Random password for login process")
                    ...
                    time.sleep(1.2)
                    play_button = driver.find_element(By.CLASS_NAME, "btn-common-play-game-lg")
                    ...
                    while not is_program_running(program_name):
                        status(f"waiting for {program_name} to open!")
